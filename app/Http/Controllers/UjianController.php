...
class UjianController extends Controller
{
    ...
    public function modal(request $request)
    {
        ...
        return view('ujian.modal',compact('template','data','disabled','id'));
    }
    public function lihat_data(request $request)
    {
        ...
        if(Auth::user()->role_id==2){
            return view('ujian.lihat_data',compact('template','data','disabled','id'));
        }
        if(Auth::user()->role_id==3){
            if($data->selesai_ujian>0){
                return view('ujian.lihat_data_siswa',compact('template','data','disabled','id','no','soal'));
            }else{
                return view('ujian.lihat_hasil_siswa',compact('template','data','disabled','id','no','soal'));
            }
    ...
    public function view_data(request $request)
    {
        ...
        return view('ujian.view_data',compact('template','data','disabled','id'));
    }
    ...
    public function get_data(request $request)
    {
        ...
        $data = $query->where('active',1)->where('mulai_ujian','>',0)->orderBy('id','Asc')->get();
    ...
    public function store(request $request){
        ...
        if($cekwaktu>0){
            ...
            $messages['cekwaktu.required']= 'Mohon maaf waktu pengisian sudah ditutupddd';
        }
