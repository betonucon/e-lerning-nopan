            ...
            success: function (data) {
              ...
              $.each(data, function(i, result){
                ...
                tampil_con='<li>'
                            ...
                            +'<span class="handle ui-sortable-handle" onclick="lihat_data_materi('+result.jenis_materi+',`'+result.file_materi+'`)"><i class="fa fa-file-pdf-o"></i></span>'
                            +'<span class="text" onclick="lihat_data_materi('+result.jenis_materi+',`'+result.file_materi+'`)" >'+result.nama_materi+'</span><small class="label label-danger"><i class="fa fa-clock-o"></i> 2 mins</small>'
                            +'<div class="tools">'
            ...
            success: function (data) {
              ...
              $.each(data, function(i, result){
                ...
                tampil_con='<li>'
                            ...
                            +'<span class="handle ui-sortable-handle" onclick="lihat_data_materi('+result.jenis_materi+',`'+result.link_video+'`)"><i class="fa fa-youtube-play"></i></span>'
                            +'<span class="text" onclick="lihat_data_materi('+result.jenis_materi+',`'+result.link_video+'`)" >'+result.nama_materi+'</span><small class="label label-danger"><i class="fa fa-clock-o"></i> 2 mins</small>'
                            +'<div class="tools">'
                              +'<i class="fa fa-edit"></i> Buka'
                            +'</div>'
                          +'</li>';
              ...
              <table class="table table-bordered">
                <tbody>
                  ...
                  <tr>
                    <td>1.</td>
                    <td>Tugas</td>
                    <td>{{tanggal_indo_lengkap($data->start_tugas)}}</td>
                    <td>{{tanggal_indo_lengkap($data->end_tugas)}}</td>
                  </tr>
                  <tr>
                    <td>2.</td>
                    <td>UJian</td>
                    <td>{{tanggal_indo_lengkap($data->start_ujian)}}</td>
                    <td>{{tanggal_indo_lengkap($data->end_ujian)}}</td>
                  </tr>
                </tbody>
              </table>
            </div>
