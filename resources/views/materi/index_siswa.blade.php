                ...
                $("#tampil-project").append('<div class="col-md-6">'
                        +'<div class="box box-widget widget-user-2" style="border: solid 1px #d4d4eb">'
                          ...
                          +'<div class="box-footer">'
                           ...
                           +'</div>'
                          +'<div class="box-footer" style="background: #f7f7ff;">'
                            
                              +'<span class="btn btn-sm btn-success" onclick="lihat('+result.id+')"  title="Lihat Materi"><i class="fa fa-book"></i> Buka Materi</span>&nbsp;&nbsp;'
                              +'<span class="btn btn-sm btn-primary" onclick="location.assign(`{{url('materi/view_forum')}}?id='+result.id+'`)"  title=""><i class="fa fa-book"></i> Forum diskusi</span>&nbsp;&nbsp;'
                           +'</div>'
                        +'</div>'
                      +'</div>');
                });
