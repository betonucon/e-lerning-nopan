            ...
            success: function (data) {
              ...
              $.each(data.data, function(i, result){
                if(result.cek_count>0 ){
                  tampil='<a class="btn btn-app " onclick="location.assign(`{{url('tugas/lihat')}}?id={{$data->id}}&no='+result.no+'`)" style="background: #a7ff00;">'+result.no+'</a>';
                  
                }else{
                  if(result.no==no ){
                    tampil='<a class="btn btn-app " onclick="location.assign(`{{url('tugas/lihat')}}?id={{$data->id}}&no='+result.no+'`)" style="background: #c1c1d5;">'+result.no+' </a>';
                  }else{
                    tampil='<a class="btn btn-app" onclick="location.assign(`{{url('tugas/lihat')}}?id={{$data->id}}&no='+result.no+'`)" >'+result.no+'</a>';
                  }
                }
