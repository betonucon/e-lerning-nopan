                    ...
                    <table id="data-table-fixed-header" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting_asc" width="8%">NIP</th>
                          <th class="sorting" >Nama</th>
                          <th class="sorting" width="15%" >Jabatan</th>
                        </tr>
                      </thead>
...
<script> 
      ...
      function tambah(id){
        ...
        $('#form-tambah').load("{{url('master/guru/modal')}}?id="+id);
      }

      function proses_user(id){
           
           swal({
               title: "Yakin memproses akses login untuk semua guru ?",
               text: "",
               type: "warning",
               icon: "error",
               ...
               if (willDelete) {
                       ...
                       $.ajax({
                           type: 'GET',
                           url: "{{url('master/guru/proses_user')}}",
                           data: "id="+id,
                           success: function(msg){
                               ...
                               var tables=$('#data-table-fixed-header').DataTable();
                                  tables.ajax.url("{{ url('master/guru/get_data')}}").load();
                           }
                       });
      ...
      function delete_data(id){
           ...
           swal({
               ...
               if (willDelete) {
                       ...
                       $.ajax({
                           type: 'GET',
                           url: "{{url('master/guru/delete_data')}}",
                           data: "id="+id,
                           success: function(msg){
